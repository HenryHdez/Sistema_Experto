...
\newline%
 \newline%
%
Con base en la información suministrada, está aplicación propone (ver Sección 1) la construcción de una hornilla Plana de una camara con capacidad de 125 kg/h (la eficiencia estimada de la hornilla es del 41\%). ; adecuada para el procesamiento de hasta 1.0 ha de caña, con una producción de panela 11 t/mes y un periodo vegetativo de 18.0 meses. Teniendo en cuenta que se realizan 1.5 moliendas al mes se estableció una jornada laboral de 5.5 días a la semana de 12 horas laborables cada una.\newline%
 Además, la aplicación estima que para garantizar una operación apropiada de la hornilla  se requiere de un área disponible de al menos 538 m²%
, cuya productividad puede aumentar al incorporar el sistema de recuperación de calor (hasta 150 kg/h) como se muestra en las tablas del análisis financiero y al final del informe. No obstante, la corporación ofrece los siguientes servicios de asistencia técnica para ajustar los valores provistos en esta propuesta de valor:%
\begin{itemize}%
\item%
...
\textbf{¿Cada cuanto va a realizar una molienda? (días)}& & & & &16\\%
\textbf{Meses de trabajo por año}& & & & &12\\%
\textbf{Semanas de trabajo por mes}& & & & &2\\%
\textbf{Días de trabajo de la hornilla por semana}& & & & &5.5\\%
\textbf{Horas de trabajo de la hornilla por día}& & & & &12\\%
\textbf{Variedades de caña sembrada}& & & & &1\\%
\textbf{Altura media sobre el nivel del mar}& & & & &1000 m\\%
\textbf{Nivel freático}& & & & &desde 100 m\\%
\textbf{Rendimiento de caña (t/ha)}& & & & &96.75\\%
\textbf{Periodo vegetativo}& & & & &18.0 mes(es)\\%
\textbf{Número de moliendas al mes}& & & & &1.5\\%
\textbf{Producción anual de caña esperada {[}t{]}}& & & & &1161\\%
\textbf{Producción anual de jugo crudo {[}t{]}}& & & & &697\\%
\textbf{Producción anual de jugo clatificado {[}t{]}}& & & & &627\\%
\textbf{Cachaza por año {[}t{]}}& & & & &42\\%
\textbf{Melto por año {[}t{]}}& & & & &23\\%
\textbf{Producción de panela anual {[}t{]}}& & & & &133\\%
\textbf{Producción de panela mensual {[}t{]}}& & & & &11\\%
\textbf{Producción de panela semanal {[}t{]}}& & & & &6\\%
\textbf{Producción de panela diaria {[}kg{]}}& & & & &1004\\%
\textbf{Panela producida por hora {[}kg{]}}& & & & &84\\%
\textbf{Caña molida {[}kg/hora{]}}& & & & &733\\%
\end{tabular}%
\newpage%
\begin{center}%
\begin{Huge}%
...
&&&&\\%
JM Estrada&Trapiche 4D&1500&16&16\\%
Panelero&R8{-}A&1500&16&12\\%
Panelero&R8{-}AC&1500&16&15\\%
Panelero&R8{-}S&1500&16&15\\%
\linebreak%
\newline%
%
\linebreak%
...
\begin{figure}[h!]%
\begin{subfigure}{0.33\linewidth}%
\includegraphics[width=0.95\linewidth]{Molinos/Trapiche 4D.jpg}%
\caption{Trapiche 4D}%
\end{subfigure}%
\begin{subfigure}{0.33\linewidth}%
\includegraphics[width=0.95\linewidth]{Molinos/R8-A.jpg}%
\caption{R8{-}A}%
\end{subfigure}%
\begin{subfigure}{0.33\linewidth}%
\includegraphics[width=0.95\linewidth]{Molinos/R8-AC.jpg}%
\caption{R8{-}AC}%
\end{subfigure}%
\linebreak%
\newpage%
